...
void coswarp(inout vec3 trip, float warpsScale ){
  ...
  trip.xyz += warpsScale * .1 * cos(3. * trip.yzx + (vTime * .05));
  trip.xyz += warpsScale * .05 * cos(11. * trip.yzx + (vTime * .05));
  trip.xyz += warpsScale * .025 * cos(17. * trip.yzx + (vTime * .05));
  trip.xyz += warpsScale * .0125 * cos(21. * trip.yzx + (vTime * .05));
}
